...
* [apache-johnzon-1.2.6-bin.zip](https://www.apache.org/dyn/closer.lua/johnzon/johnzon-1.2.6/apache-johnzon-1.2.6-bin.zip)
* [apache-johnzon-1.2.6-bin.zip.sha1](https://www.apache.org/dist/johnzon/johnzon-1.2.6/apache-johnzon-1.2.6-bin.zip.sha1)
* [apache-johnzon-1.2.6-bin.zip.asc](https://www.apache.org/dist/johnzon/johnzon-1.2.6/apache-johnzon-1.2.6-bin.zip.asc)

#### Source
Should you want to build any of the above binaries, this source bundle is the right one and covers them all.

* [johnzon-1.2.6-source-release.zip](https://www.apache.org/dyn/closer.lua/johnzon/johnzon-1.2.6/johnzon-1.2.6-source-release.zip)
* [johnzon-1.2.6-source-release.zip.sha1](https://www.apache.org/dist/johnzon/johnzon-1.2.6/johnzon-1.2.6-source-release.zip.sha1)
* [johnzon-1.2.6-source-release.zip.asc](https://www.apache.org/dist/johnzon/johnzon-1.2.6/johnzon-1.2.6-source-release.zip.asc)
