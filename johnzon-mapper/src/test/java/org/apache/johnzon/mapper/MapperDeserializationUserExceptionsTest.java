...
public class MapperDeserializationUserExceptionsTest {
    ...
    public void objectFromObject() throws Exception {
        assertMessage("{ \"object\" : {\"red\": 255, \"green\": 165, \"blue\":0} }",
                "Error calling public void org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Widget.setObjec" +
                        "t(org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Color)");
    }

    @Test
    public void stringFromString() throws Exception {
        assertMessage("{ \"string\" : \"Supercalifragilisticexpialidocious\" }",
                "Error calling public void org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Widget.setStrin" +
                        "g(java.lang.String)");
    }
    ...
    public void numberFromNumber() throws Exception {
        assertMessage("{ \"number\" : 122333444455555.666666777777788888888 }",
                "Error calling public void org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Widget.setNumbe" +
                        "r(java.lang.Double)");
    }
    ...
    public void arrayOfObjectFromArrayOfObject() throws Exception {
        assertMessage("{ \"arrayOfObject\" : [{\"red\": 255, \"green\": 165, \"blue\":0},{\"red\": 0, \"green\": 45, \"blue\":127}] }",
                "Error calling public void org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Widget.setArray" +
                        "OfObject(org.apache.johnzon.mapper.MapperDeserializationUserExceptionsTest$Color[])");
    }
    ...
    public static String getExceptionMessage(final String json) {
        try (final Mapper mapper = new MapperBuilder().setSnippetMaxLength(20).build()) {
            ...
            final Widget widget = mapper.readObject(json, Widget.class);
