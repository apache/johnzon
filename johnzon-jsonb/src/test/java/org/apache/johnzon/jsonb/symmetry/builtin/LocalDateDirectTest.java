 ...
 */
public class LocalDateDirectTest extends BuiltInSymmetryTest {

    @Override
    public void assertWrite(final Jsonb jsonb) {
        assertEquals("\"2024-01-15\"", jsonb.toJson(LocalDate.of(2024, 1, 15)));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        assertEquals(LocalDate.of(2024, 1, 15), jsonb.fromJson("\"2024-01-15\"", LocalDate.class));
    }
}
