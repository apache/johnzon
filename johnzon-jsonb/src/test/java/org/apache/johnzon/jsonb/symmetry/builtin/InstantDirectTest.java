 ...
 */
public class InstantDirectTest extends BuiltInSymmetryTest {

    @Override
    public void assertWrite(final Jsonb jsonb) {
        assertEquals("\"2024-01-15T10:30:45Z\"", jsonb.toJson(Instant.parse("2024-01-15T10:30:45Z")));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        assertEquals(Instant.parse("2024-01-15T10:30:45Z"), jsonb.fromJson("\"2024-01-15T10:30:45Z\"", Instant.class));
    }
}
