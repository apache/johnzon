 ...
 */
public class PeriodDirectTest extends BuiltInSymmetryTest {

    @Override
    public void assertWrite(final Jsonb jsonb) {
        assertEquals("\"P1Y2M3D\"", jsonb.toJson(Period.of(1, 2, 3)));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        assertEquals(Period.of(1, 2, 3), jsonb.fromJson("\"P1Y2M3D\"", Period.class));
    }
}
