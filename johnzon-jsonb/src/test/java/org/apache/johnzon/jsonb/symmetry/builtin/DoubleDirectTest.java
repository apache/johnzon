 ...
 */
public class DoubleDirectTest extends BuiltInSymmetryTest {

    @Override
    public void assertWrite(final Jsonb jsonb) {
        assertEquals("1.5", jsonb.toJson(1.5));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        assertEquals(Double.valueOf(1.5), jsonb.fromJson("1.5", Double.class));
    }
}
