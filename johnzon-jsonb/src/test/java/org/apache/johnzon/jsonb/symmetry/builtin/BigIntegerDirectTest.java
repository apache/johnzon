 ...
 */
public class BigIntegerDirectTest extends BuiltInSymmetryTest {
    ...
    public void assertWrite(final Jsonb jsonb) {
        assertEquals("42", jsonb.toJson(BigInteger.valueOf(42)));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        assertEquals(BigInteger.valueOf(42), jsonb.fromJson("42", BigInteger.class));
    }
}
