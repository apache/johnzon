...
public class OffsetDateTimeSimpleTest extends BuiltInSymmetryTest {
    ...
    public static class Widget {
        ...
        public void setValue(final OffsetDateTime value) {
            this.value = value;
        }
    }
    ...
    public void assertWrite(final Jsonb jsonb) {
        ...
        widget.setValue(OffsetDateTime.of(2024, 1, 15, 10, 30, 45, 0, ZoneOffset.UTC));
    ...
    public void assertRead(final Jsonb jsonb) {
        ...
        assertEquals(OffsetDateTime.of(2024, 1, 15, 10, 30, 45, 0, ZoneOffset.UTC), widget.getValue());
    }
}
