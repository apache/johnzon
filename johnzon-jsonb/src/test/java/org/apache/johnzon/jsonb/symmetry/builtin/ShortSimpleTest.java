 ...
 */
public class ShortSimpleTest extends BuiltInSymmetryTest {
    ...
    public void assertWrite(final Jsonb jsonb) {
        ...
        widget.setValue((short) 256);
        assertEquals("{\"value\":256}", jsonb.toJson(widget));
    }

    @Override
    public void assertRead(final Jsonb jsonb) {
        final Widget widget = jsonb.fromJson("{\"value\":256}", Widget.class);
        assertEquals(Short.valueOf((short) 256), widget.getValue());
    }
}
